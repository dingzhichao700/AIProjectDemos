...
public static class FrameworkSetup
{
    ...
    static void CreateGameEntranceScene()
    {
        ...
        SetupCanvas(canvasScale, true, true);

        GameObject safeAreaRoot = new GameObject("SafeAreaRoot", typeof(RectTransform), typeof(SafeAreaFitter));
        safeAreaRoot.transform.SetParent(canvasScale.transform, false);
        ...
        SetupCanvas(canvasConstantPixel, true, false);

        GameObject uiPool = new GameObject("uiPool");
        SetupCanvas(uiPool, false, true);
        ...
        engineSo.FindProperty("safeAreaRoot").objectReferenceValue = safeAreaRoot.GetComponent<RectTransform>();
    ...
    static void SetupCanvas(GameObject go, bool withRaycaster, bool scaleWithScreen)
    {
