...
public class PanelMgr : EventDispatcher {
    ...
    /**设置UI节点*/
    public void SetUIRoot(RectTransform viewportScale, RectTransform viewportConstant, RectTransform safeAreaRoot, RectTransform uiPool) {
